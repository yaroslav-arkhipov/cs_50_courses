...
begin
   if TmpLng=1 then
  begin
   Form4.Button1.Caption:='Загрузить картинку';
   Form4.Button2.Caption:='Изменить размер';
   Form4.Button3.Caption:='Сохранить картинку';
   if BmpCreated=1 then
    Form4.Label1.Caption:='Начальные размеры: ширина '+IntToStr(BMP.Width)+' высота '+IntToStr(BMP.Height)
   else
    Form4.Label1.Caption:='Начальные размеры:';
   if BmpResized=1 then
     Form4.Label2.Caption:='Измененные размеры: ширина '+IntToStr(BMP.Width)+' высота '+IntToStr(BMP.Height)
   else
    Form4.Label2.Caption:='Измененные размеры:';
   Form4.Label3.Caption:='Ширина:';
   Form4.Label4.Caption:='Высота:';
   TmpLng:=0;
  end
  else
  begin
...
Label1.Caption:='Начальные размеры: ширина '+IntToStr(BMP.Width)+' высота '+IntToStr(BMP.Height);
Edit1.Visible:=True;
Edit2.Visible:=True;
...
begin
  if TmpLng=1 then
    ...
    ShowMessage('Введите новые размеры картинки');
  Exit;
end
else
begin
  ...
  if TmpLng=1 then
    ...
    ShowMessage('Введите правильную ширину (целое число)');
    Exit;
   end;
  ...
  if TmpLng=1 then
    ...
    ShowMessage('Введите правильную высоту (целое число)');
    Exit;
   end;
BMP.Width:=NewWidth;
...
Label2.Caption:='Измененный размер: ширина '+IntToStr(BMP.Width)+' высота '+IntToStr(BMP.Height);
